    ...
    <>
      <div className="hotel-content">
        ...
        <div className="about-hotel pt-5">
          ...
          <p className="mt-3">
            SANTIPHAP ROOM - is a spacious en-suite located on the top floor of
            the renovated 40-year old shophouse. The room is a Thai-contemporary
            inspired, overlooking one of the most sacred Temple and a balcony
            with little garden.
          </p>
          <p>
            SANTIPHAP ROOM - is a spacious en-suite located on the top floor of
        ...
        <div className="hotel-location">
          ...
          <p>
            Be immersed in an atmosphere of Thai-Chinese commercial culture in
            this bustling neighborhood where there are many herb markets and
            traditional medicine shops. There is a great bar on the main floor
            of the building and the famous street food of Chinatown is just a
            five-minute walk away. Other great, unique bars in the area include
            Tep Bar, Teens of Thailand, and El Chiringuito!
          </p>
        </div>
